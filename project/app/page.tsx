...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      {/* ===== CARD CONTAINER - DOES NOT ROTATE ===== */}
      <div className="relative z-10 w-full max-w-md">
        
        {/* ===== GLOW - SEPARATE ELEMENT, ONLY THIS ROTATES ===== */}
        <div 
          ref={glowRef}
        ...
        <div
          ref={cardRef}
          className="relative z-10 bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-10"
        >
